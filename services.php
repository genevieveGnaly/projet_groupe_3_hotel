  ...
  <div class="carousel-inner" role="listbox">
    <div class="item active">
      <div class="slidee">
        ...
        <div class="slideee">
      <figure> 
        <img src="img/sal2.jpg" alt="Life is good" style="width: 1500px;height: 600px;z-index: 80">
      </figure>
      <figure>
        <img src="img/pi2.jpg" alt="Life is good" style="width: 1500px;height: 600px;z-index: 80">
      </figure>
      <figure>
        <img src="img/sal1.jpg" alt="Life is good" style="width: 1500px;height: 600px;z-index: 80">
      </figure>
    </div>

     </div>
      <div class="carousel-caption">
        <p><strong> SERVICE DISPONIBLE POUR TOUS</strong></p>
      </div>
  </div>
...
<hr>
<br><br>
<h1><strong>AUTRES SERVICES</strong></h1>
...
<hr>
  ...
  <div class="col-sm-4">
    ...
    <?php echo $affiche['titre_service']; ?>
    ...
    <img src="img/<?php echo $affiche['image']; ?>.jpg" style="width: 360px;height: 220px;">
