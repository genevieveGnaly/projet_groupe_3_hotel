...
$requet_insert="INSERT INTO form_sport (id_spo,nom_spo,prenom_spo,sexe_spo,dabonne_spo,contact_spo) VALUES(?,?,?,?,?,?)";
...
<div class="row">
	<div class="col-sm-6 col-sm-offset-3">
		<legend><strong>Abonnement sport</strong></legend>
		<form method="post">
	...
	<div class="form-group">
		...
		<input type="number" name="dureabon" placeholder="Durée d'abonnement mensuel" class="form-control" min="1" max="12">
	</div>
